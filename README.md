...
| `oparl` | [oparl-cli](https://github.com/maschinenlesbar-org/oparl-cli) | Follow a German city or municipal council through its OParl council information system (Ratsinformationssystem) — find the endpoint, then its bodies, meetings, papers and committees — via the oparl-cli. Open data; licence varies per endpoint. |
